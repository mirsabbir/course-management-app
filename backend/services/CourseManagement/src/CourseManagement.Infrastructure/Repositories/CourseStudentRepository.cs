...
namespace CourseManagement.Infrastructure.Repositories
{
    public class CourseStudentRepository : ICourseStudentRepository
    {
        ...
        public async Task<IEnumerable<CourseStudent>> GetStudentsByCourseIdAsync(Guid courseId)
        {
            return await _context.CourseStudents
        ...
        public async Task<IEnumerable<CourseStudent>> GetCoursesByStudentIdAsync(Guid studentId)
        {
            return await _context.CourseStudents
