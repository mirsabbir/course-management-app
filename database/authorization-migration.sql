...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250222151823_test_migration') THEN
...
BEGIN
    ...
    VALUES ('20250222151823_test_migration', '9.0.2');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250222184748_test_migration2') THEN
    ALTER TABLE "Invitations" ADD "FullName" text NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20250222184748_test_migration2') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20250222184748_test_migration2', '9.0.2');
    END IF;
END $EF$;
COMMIT;
